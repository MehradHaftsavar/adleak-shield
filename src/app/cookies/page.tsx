        ...
        <div className="space-y-10 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              <a href="/terms" className="text-blue-600 hover:underline">Terms of Service</a> and our{' '}
              <a href="/privacy" className="text-blue-600 hover:underline">Privacy Policy</a> for your
